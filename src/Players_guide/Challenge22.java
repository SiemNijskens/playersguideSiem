...
to randomly place the Manticore so that it can be a single-player game.
    */
    ...
    // user input voor piloot method maken met max en min waarde
    // velden voor city health, manticore health, round nr, cannon damage enz maken
    // user input voor cannon schieter maken
    // overshoot/fell short berekening maken
